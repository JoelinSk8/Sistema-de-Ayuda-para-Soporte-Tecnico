...
class Reportes extends Conexion
{
    public function agregarReporteCliente($datos)
    {
        ...
        $sql = "INSERT INTO t_reporte(id_usuario,id_equipo,descripcion_problema) VALUES(?, ?, ?)";
    ...
    {
        $conexion = Conexion::conectar();
        $sql = "DELETE FROM t_reporte WHERE id_reporte = ?";
        $query = $conexion->prepare($sql);
    ...
    {
        $conexion = Conexion::conectar();
        $sql = "SELECT solucion_problema,estatus FROM t_reporte WHERE id_reporte = '$idReporte' ";
