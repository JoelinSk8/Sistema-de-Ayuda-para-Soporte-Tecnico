...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto">
                    ...
                    <?php } else if ($_SESSION['usuario']['rol'] == 2) { ?>
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="asignacion.php">
                                <span class="fas fa-file-signature"></span> Asignacion</a>
                        </li>
                        <li class="nav-item active">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" style="color:blue" ; href="#" role="button" data-toggle="dropdown" aria-expanded="false">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modalActualizarDatosPersonales" onclick="obtenerDatosPersonalesInicio('<?php echo $_SESSION['usuario']['id']; ?>')">
                                <span class="fas fa-user-edit"></span> Actualizar Datos
                            </a>
    ...
    <?php include "inicio/modaActualizarDatosPersonales.php"; ?>
